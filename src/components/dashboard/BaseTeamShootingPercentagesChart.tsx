...
export function BaseTeamShootingPercentagesChart({ playerStats }: Props) {
    const chartData = playerStats
        .map((player) => {
            ...
            return {
                ...
                fgMade: totalFgMade,
                fgAttempts: totalFgAttempts,
                threeMade: totalThreeMade,
                threeAttempts: totalThreeAttempts,
            };
        })
                            ...
                            return (
                                <div className='bg-background rounded-lg border p-2 shadow-sm'>
                                    ...
                                    <div className='text-muted-foreground text-sm'>
                                        FG: {data.fgMade}/{data.fgAttempts} (
                                        {data.fgPercentage}%)
                                    </div>
                                    <div className='text-muted-foreground text-sm'>
                                        3P: {data.threeMade}/
